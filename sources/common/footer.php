  ...
  <body class="bg-main">
    <footer class="fixed bottom-0 w-full">
      <div class="bg-thingreen">
        ...
        <div
          class="mx-auto w-full max-w-screen-xl flex-col p-4 md:flex md:items-center md:justify-between"
        >
          <ul
            class="mt-3 flex flex-wrap items-center text-base sm:mb-10 text-explain"
          >
            <li>
          ...
          <span class="text-xs text-explain sm:text-center"
            >© 2024 GarbaGe Inc.
          </span>
        </div>
      </div>
