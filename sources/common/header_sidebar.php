            ...
            <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-96 transition-transform -translate-x-full sm:translate-x-0 pt-16" aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto bg-main">
                    <ul class="space-y-2 font-medium">
                        <li>
                            <a href="<?php echo ABSOLUTE_URL; ?> /sources/user/mypage.php" class="flex items-center p-2 text-explain rounded-lg ">
                                <span class="ms-3">プロフィール</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo ABSOLUTE_URL; ?> /sources/user/message_history.php" class="flex items-center p-2 text-explain rounded-lg ">
                                <span class="ms-3">メッセージ履歴</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo ABSOLUTE_URL; ?> /sources/user/order_history.php" class="flex items-center p-2 text-explain rounded-lg ">
